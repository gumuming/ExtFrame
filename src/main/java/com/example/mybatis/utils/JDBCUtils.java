...
public final class JDBCUtils {
    ...
    private static void config() {
         ...
         * 获取URL
         */
        URL = "jdbc:mysql://mysql.test.masterscm.com:33306/sta_worker?autoReconnect=true&zeroDateTimeBehavior=convertToNull&useSSL=false&characterEncoding=utf-8&useAffectedRows=true&allowMultiQueries=true";
        /*
         * 获取用户名
         */
        username = "sta_worker";
